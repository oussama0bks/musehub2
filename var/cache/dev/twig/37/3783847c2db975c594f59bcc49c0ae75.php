...
class __TwigTemplate_3159a8fbfe82db168111a2a6d9ea85d9 extends Template
{
    ...
    <div class=\"row justify-content-center\">
        <div class=\"col-md-8\">
            <h1 class=\"mb-4\">
                <i class=\"fas fa-edit\"></i> Éditer l'Offre #";
        // line 10
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["offre"]) || array_key_exists("offre", $context) ? $context["offre"] : (function () { throw new RuntimeError('Variable "offre" does not exist.', 10, $this->source); })()), "id", [], "any", false, false, false, 10), "html", null, true);
        yield "
            </h1>
        ...
        yield "
                ...
                <div class=\"d-flex gap-2\">
                    ...
                    <a href=\"";
        // line 49
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("offre_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["offre"]) || array_key_exists("offre", $context) ? $context["offre"] : (function () { throw new RuntimeError('Variable "offre" does not exist.', 49, $this->source); })()), "id", [], "any", false, false, false, 49)]), "html", null, true);
...
";
    ...
    {
        return array (  205 => 54,  197 => 49,  187 => 42,  183 => 41,  179 => 40,  172 => 36,  168 => 35,  164 => 34,  157 => 30,  153 => 29,  149 => 28,  142 => 24,  138 => 23,  134 => 22,  127 => 18,  123 => 17,  119 => 16,  113 => 13,  107 => 10,  101 => 6,  88 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}Éditer l'Offre #{{ offre.id }}{% endblock %}
...
<div class=\"container mt-5\">
    <div class=\"row justify-content-center\">
        <div class=\"col-md-8\">
            <h1 class=\"mb-4\">
                <i class=\"fas fa-edit\"></i> Éditer l'Offre #{{ offre.id }}
            </h1>
            ...
            {{ form_start(form, {'attr': {'class': 'needs-validation', 'novalidate': 'novalidate'}}) }}
                ...
                <div class=\"mb-3\">
                    ...
                    {{ form_widget(form.listing, {'attr': {'class': 'form-control', 'disabled': 'disabled'}}) }}
                    {{ form_errors(form.listing) }}
                </div>

                <div class=\"mb-3\">
                    {{ form_label(form.utilisateur) }}
                    {{ form_widget(form.utilisateur, {'attr': {'class': 'form-control', 'disabled': 'disabled'}}) }}
                ...
                <div class=\"d-flex gap-2\">
                    ...
                    <a href=\"{{ path('offre_show', {id: offre.id}) }}\" class=\"btn btn-secondary\">
                        <i class=\"fas fa-arrow-left\"></i> Retour
                    </a>
                </div>
...
{% endblock %}
", "offre/edit.html.twig", "C:\\xampp\\htdocs\\MuseHub-my-work\\MuseHub-my-work\\templates\\offre\\edit.html.twig");
    }
}
